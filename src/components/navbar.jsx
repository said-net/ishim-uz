...
function Navbar() {
    ...
    return (
        <div className="flex items-center justify-center w-full h-[100px]">
            <nav className="w-full h-[100px] flex items-center justify-between fixed top-0 left-0 bg-white shadow-[0_10px_20px] shadow-[#0000000f] px-[2%]">
                ...
                <div className="flex items-center justify-between w-[550px] tablet:w-[180px]">
                    ...
                    <Button color="indigo" className="w-[120px]">
                        {lang?.nav?.sign}
                    </Button>
                    <Menu className={"w-[100px]"}>
                        ...
                        <MenuList className=" min-w-0 flex items-center justify-center flex-col">
                            {lang?.title === 'uz' ?
            ...
            <div className="items-center justify-around w-full h-[60px] hidden tablet:flex fixed bottom-0 left-0 bg-white shadow-[0_-10px_20px] shadow-[#0000000f] px-[2%]">
